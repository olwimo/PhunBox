...
public class CoreMidiVirtualDestination implements CoreMidiSourceInterface {
    ...
    /**
     * Creates a virtual CoreMIDI destination.
     *
     * @param deviceProvider CoreMidi Device Provider
     * @param midiClientReference	MidiClient Reference
     * @param destinationName	Virtual Destination Name
     *
     */
    CoreMidiVirtualDestination(CoreMidiDeviceProvider deviceProvider, final int midiClientReference,
                               String destinationName) throws CoreMidiException {
        ...
        this.memoryHandle = deviceProvider.createCallback(this);
        this.endPointReference = deviceProvider
                .createDestination(midiClientReference, memoryHandle, destinationName);
        this.info = deviceProvider.getMidiDeviceInfo(this.endPointReference);
     ...
     */
    public void transmitterClosed(CoreMidiTransmitter transmitter) {
