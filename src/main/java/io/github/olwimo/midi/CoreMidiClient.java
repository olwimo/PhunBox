...
public class CoreMidiClient {
     ...
     *
     * @param name 	The name of the client
     * @param setter 	Setter for the client reference
     *
     * @throws 			CoreMidiException if the client cannot be initialized
     *
     */

    public CoreMidiClient(String name, Consumer<Integer> setter) throws CoreMidiException {

        midiClientReference = this.createClient(name);
        setter.accept(midiClientReference);
